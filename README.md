...
+ GiST - фреймворк для построения R-деревьев с различными классами операторов. Используется для поиска ближайших объектов, крайне полезен  при работе с геоданными.
